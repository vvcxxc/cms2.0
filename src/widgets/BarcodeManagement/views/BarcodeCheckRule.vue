<template>
  <div class="bar-content">
    <div class="bar-header">
      <IconButton
        v-permission="'checked-management-add'"
        icon="add-p"
        type="primary"
        @click="onAdd"
      >
      ...
      <IconButton
        v-permission="'checked-management-edit'"
        icon="edit"
        @click="onEdit"
      >
        编辑
      ...
      <IconButton
        v-permission="'checked-management-delete'"
        icon="delete"
        @click="onDelete"
        >删除</IconButton
      >
      <IconButton
        v-permission="'checked-management-view'"
        icon="view"
        @click="onView"
        >查看</IconButton
      >
    ...
    <div class="table-content">
      <BaseTable
        ...
        :columns="BarcodeCheckRuleColumns"
        :isChecked="true"
        :isFooter="false"
        @check="onCheck"
      >
...
import { deleteBarcodeverification, deleteData } from '../action'
// import Table from 'components/Table/index.vue'
import BarcodeCheckRuleDialog from '../components/BarcodeCheckRuleDialog.vue'
import { Row, BarcodeAnalysisCurrent, BarcodeCheckRuleColumns } from '../state'
...
const onDelete = (row: any) => {
  ...
  ConfirmBox('条码删除后不可恢复，是否确认删除？').then(async () => {
    ...
    await deleteBarcodeverification(ids as string[])
